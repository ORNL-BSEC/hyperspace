...
from hyperspace.exception import HyperspaceException
    ...
    def resolve(self, parameters):
        ...
        if self.default_value == DUMMY_VALUE:
            if self.name in parameters:
                ...
                raise HyperspaceException(f"Undefined parameter: {self.name}")
        else:
    ...
    def resolve(self, _):
        ...
        if self.default_value == DUMMY_VALUE:
            if self.name in os.environ:
                ...
                raise HyperspaceException(f"Undefined environment variable: {self.name}")
        else:
